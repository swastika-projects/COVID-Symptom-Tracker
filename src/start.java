...
public class start {
	...
	public static void patient() throws NumberFormatException, IOException
	{
		...
		case 4:
			...
			int pid = Integer.parseInt(
					JOptionPane.showInputDialog(null, "Enter Patient ID ", "Get Information", JOptionPane.QUESTION_MESSAGE)
					);
			Patient_operation.patientGetInfo(pid);
			break;
		case 5:
	...
	public static void vaccinated() throws NumberFormatException, IOException
	{
		...
		//while(n3!=0) {
		 ...
		 n3= Integer.parseInt(
						JOptionPane.showInputDialog(null, str, "Vaccinated Person Options", JOptionPane.QUESTION_MESSAGE)
						);
		...
		case 5:
			//get info
			int vid = Integer.parseInt(
					JOptionPane.showInputDialog(null, "Enter COWIN ID ", "Get Information", JOptionPane.QUESTION_MESSAGE)
					);
			vaccinated_operation.VaccinatedGetInfo(vid);
			break;
		}
		//}
	}
